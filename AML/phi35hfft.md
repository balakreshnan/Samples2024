# PHI 3.5 fine tuning locally from Hugging Face (Simulated in Azure Machine learning)

## Introduction

- Run PHI 3.5 in local GPU Compute instance
...
```
project_name = "Phi3-5-mini-ft-python-code"
...
![info](https://github.com/balakreshnan/Samples2024/blob/main/AML/images/phi35hfft-1.jpg 'Phi3 128K instruct Model')


- Save the adapter to Hugging Face

```
hf_model_repo = 'Balab2021/bbphi35ftv1'
trainer.push_to_hub("Balab2021/adapter-phi-3-5-mini-py_code")
```
...
merged_model.save_pretrained("merged_model35", trust_remote_code=True, safe_serialization=True)

# 'tokenizer.save_pretrained' is a method that saves the tokenizer.
# The tokenizer is saved in the directory "merged_model".

tokenizer.save_pretrained("merged_model35")
```
...
![info](https://github.com/balakreshnan/Samples2024/blob/main/AML/images/phi35hfft-2.jpg 'Phi3 128K instruct Model')
...
```
hf_model_repo = 'Balab2021/bbphi35ftv1' if not hf_model_repo else hf_model_repo
```
...
![info](https://github.com/balakreshnan/Samples2024/blob/main/AML/images/phi35hfft-4.jpg 'Phi3 128K instruct Model')
...
![info](https://github.com/balakreshnan/Samples2024/blob/main/AML/images/phi35hfft-5.jpg 'Phi3 128K instruct Model')
![info](https://github.com/balakreshnan/Samples2024/blob/main/AML/images/phi35hfft-6.jpg 'Phi3 128K instruct Model')
![info](https://github.com/balakreshnan/Samples2024/blob/main/AML/images/phi35hfft-7.jpg 'Phi3 128K instruct Model')
![info](https://github.com/balakreshnan/Samples2024/blob/main/AML/images/phi35hfft-8.jpg 'Phi3 128K instruct Model')
![info](https://github.com/balakreshnan/Samples2024/blob/main/AML/images/phi35hfft-9.jpg 'Phi3 128K instruct Model')

- Now we have completed end to end fine tuning phi3.5 and tested the model.